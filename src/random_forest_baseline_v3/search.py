"""Small group-aware hyperparameter search for the Random-Forest baseline v3."""
...
from src.random_forest_baseline.modeling import evaluate_grouped_dataset


DEFAULT_CONFIG_PATH = "baseline_models/random_forest_v3/config.json"
DEFAULT_SEARCH_OUTPUT_DIR = "baseline_models/random_forest_v3/output"
...
def main() -> None:
    ...
    print("Random-Forest baseline v3 search finished.")
