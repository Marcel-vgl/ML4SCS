"""Train the Random-Forest baseline v3 with merged non-stroke labels."""
...
DEFAULT_CONFIG_PATH = "baseline_models/random_forest_v3/config.json"
...
def main() -> None:
    ...
    print("Random-Forest baseline v3 model trained.")
