"""Train the v_r_v2 multi-class model with the baseline Random-Forest pipeline."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    for action in parser._actions:
        if action.dest == "config":
            ...
            break
    parser.add_argument("--model-output-path", help="Override the serialized v_r_v2 output path.")
    return parser
...
def main() -> None:
    ...
    print("v_r_v2 training finished.")
